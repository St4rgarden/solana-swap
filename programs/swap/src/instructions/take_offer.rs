...
pub struct TakeOffer<'info> {
    ...
    #[account(
        mut,
        // the close constraint refunds the lamports to the specified account
        // it then deletes all data and re-assigns its ownership to system program
        close = maker,
        // has_one is a constraint that validates the account has a specific value
        has_one = maker,
...
// This function transfers tokens from the vault to the maker
// this means that it's being signed for by our offer account
